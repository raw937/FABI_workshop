---
title: "Metagenomics and Metatranscriptomics Workshop_Vegan"
author: "María Vivas"
...
lines(sp_ac_curve_B, lty = 2, col = "red")  ## add another variable
...
plot(sort.count_A, type="l",cex.axis=0.7, las=1, 
     ylab="Number of individuals", xlab="Species rank")
lines(sort.count_B, type = "l", lty = 2, col = "red")  ## add another variable
...
plot(abundance_dbrda, display=c("sp","wa","bp")) 
